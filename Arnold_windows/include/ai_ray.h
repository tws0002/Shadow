...
inline bool AiTrace(const AtRay* ray, const AtRGB& weight, AtScrSample* sample);
...
AI_API bool AiTraceWeighted(const AtRay* ray, const AtRGB& weight, AtScrSample* sample);
inline bool AiTrace(const AtRay* ray, const AtRGB& weight, AtScrSample* sample)
{ return AiTraceWeighted(ray, weight, sample); }
/// @endcond
