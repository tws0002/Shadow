 ...
 */
template <typename T1, typename T2>
inline T1 BILERP(T2 s, T2 t, T1 c00, T1 c10, T1 c01, T1 c11)
{
   T1 c0x = LERP(t, c00, c01);
   T1 c1x = LERP(t, c10, c11);
 ...
 */
template <typename T1, typename T2>
inline T1 BIHERP(T2 s, T2 t, T1 c00, T1 c10, T1 c01, T1 c11)
{
   T1 c0x = HERP(t, c00, c01);
   T1 c1x = HERP(t, c10, c11);
...
AI_API AI_CONST bool AiIsFinite(float x);

AI_API AI_CONST float fast_exp(float x);
