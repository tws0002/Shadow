 ...
 * \{
 */
AI_API AI_PURE  const char*         AiParamGetName    (const AtParamEntry* pentry);
AI_API AI_PURE  int                 AiParamGetType    (const AtParamEntry* pentry);
...
AI_API AI_PURE  const char*         AiParamGetTypeName(AtByte type);
AI_API AI_CONST int                 AiParamGetTypeSize(AtByte type);
/* \}*/
 ...
 * \{
 */
AI_API AI_PURE  const char* AiUserParamGetName     (const AtUserParamEntry* upentry);
AI_API AI_PURE  int         AiUserParamGetType     (const AtUserParamEntry* upentry);
AI_API AI_PURE  int         AiUserParamGetArrayType(const AtUserParamEntry* upentry);
AI_API AI_PURE  int         AiUserParamGetCategory (const AtUserParamEntry* upentry);
AI_API AI_CONST int         AiUserParamGetIndex    (const AtUserParamEntry* upentry);  // DEPRECATED
/* \}*/
 ...
 * dst_type.
 *
 * For instance, AiParamTypeConvertible(AI_TYPE_FLOAT, AI_TYPE_INT)
 ...
 */
AI_API AI_CONST bool AiParamTypeConvertible(int dst_type, int src_type);
