...
AI_API AI_PURE AtPoint2 AiAOVSampleIteratorGetOffset(const AtAOVSampleIterator* iter);
...
AI_API AI_PURE bool     AiAOVSampleIteratorHasAOVValue(const AtAOVSampleIterator* iter, const char* name, AtByte type);
/* \}*/
...
AI_API AI_PURE AtPoint     AiAOVSampleIteratorGetPnt (const AtAOVSampleIterator* iter);
AI_API AI_PURE AtPoint2    AiAOVSampleIteratorGetPnt2(const AtAOVSampleIterator* iter);
...
AI_API AI_DEPRECATED AI_PURE _type AiAOVSampleIteratorGetAOV##_name          (const AtAOVSampleIterator* iter, const char* name);   \
AI_API               AI_PURE _type AiAOVSampleIteratorGetAOV##_name##AtString(const AtAOVSampleIterator* iter, const AtString name);\
inline                       _type AiAOVSampleIteratorGetAOV##_name          (const AtAOVSampleIterator* iter, const AtString name) \
{                                                                                                                                   \
   return AiAOVSampleIteratorGetAOV##_name##AtString(iter, name);                                                                   \
}
